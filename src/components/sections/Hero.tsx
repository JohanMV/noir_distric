    ...
    <section className="page-shell page-shell--top" aria-labelledby="hero-title">
      <div className="relative min-h-[760px] overflow-hidden rounded-[2rem] bg-hero md:rounded-[2.75rem] xl:min-h-[820px]">
        ...
        <div className="grid min-h-[680px] lg:grid-cols-[1.06fr_0.94fr]">
          <motion.div initial={reduceMotion ? false : { opacity: 0, x: -24 }} animate={reduceMotion ? undefined : { opacity: 1, x: 0 }} transition={{ duration: 0.65, ease: "easeOut" }} className="relative z-10 flex flex-col justify-center px-6 py-10 md:px-10 xl:px-14">
